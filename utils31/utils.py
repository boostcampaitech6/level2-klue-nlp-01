...
def label_to_num(label):
    ...
    dict_label_to_num = {key: value + 1 for key, value in dict_label_to_num.items() if key != 'no_relation'}
    dict_label_to_num['per:no_relation'] = 0
    dict_label_to_num['org:no_relation'] = 1
    for v in label:
...
def num_to_label(label):
  ...
  dict_num_to_label = {key + 1: value for key, value in dict_num_to_label.items() if key != 0}
  dict_num_to_label[0] = 'per:no_relation'
  dict_num_to_label[1] = 'org:no_relation'
  for v in label:
