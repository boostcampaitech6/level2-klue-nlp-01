...
class LDAMLoss(nn.Module):
    def __init__(self, cls_num_list, max_m=0.5, weight=None, s=31):
...
class LabelSmoothingLoss(nn.Module):
    def __init__(self, classes=31, smoothing=0.05, dim=-1):
...
def klue_re_micro_f1(preds, labels):
    ...
    label_list = ['per:no_relation','org:no_relation', 'org:top_members/employees', 'org:members',
       ...
       'per:religion']
    no_relation_label_idx = label_list.index("org:no_relation")
    no_relation_label_idx = label_list.index("per:no_relation")
